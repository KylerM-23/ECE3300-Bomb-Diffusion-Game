...
module GameWinMusicSheet( input [9:0] number, 
    ...
    always @ (number) begin
        case(number)
            0: begin note = A4; duration = QUARTER; end
            1: begin note = B4; duration = QUARTER; end
            2: begin note = D3; duration = QUARTER; end
            3: begin note = E3; duration = QUARTER; end
            4: begin note = A4; duration = QUARTER; end
            5: begin note = B4; duration = QUARTER; end
            6: begin note = D3; duration = QUARTER; end
            7: begin note = E3; duration = QUARTER; end
            default: 	begin note = C4; duration = ONE; 	end
        endcase
    end
endmodule

module GameWinSongPlayer( input clock, input playSound, output reg audioOut, output wire aud_sd);
    reg [19:0] counter;
    reg [2:0] plays;
    ...
    GameWinMusicSheet 	GameWinSong(number, notePeriod, duration);
